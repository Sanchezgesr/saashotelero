    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
      ...
      <div className="flex justify-end gap-2 pt-2 border-t border-gray-100">
        ...
        <button type="submit" disabled={saving}
          className="px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:opacity-90 disabled:opacity-50 cursor-pointer">
          {saving ? 'Guardando...' : (editingGuest ? 'Guardar Cambios' : 'Registrar Cliente')}
        </button>
      </div>
    </form>
  )
